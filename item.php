...
<html lang="en">
  <head>
    <title><?=$arrAllData['sitetitle']['header']?> - <?=$arrAllData['portfolio']['headers'][0]?></title>
    <!-- Настройка favicon -->
    ...
    <!-- Дескрипшин страницы-->
    <meta name="description" content="<?=mb_strimwidth(Strip_tags(trim($arrAllData['portfolio']['texts'][0])), 0, 160, "...")?>">
